...
public class Block {
	...
	public static void loadImages() {
		try {
			blank = ImageIO.read(Block.class.getResource("/com/bohdan/resources/blank.png"));
			flag = ImageIO.read(Block.class.getResource("/com/bohdan/resources/flag.png"));
			hitMine = ImageIO.read(Block.class.getResource("/com/bohdan/resources/hitMine.png"));
			mine = ImageIO.read(Block.class.getResource("/com/bohdan/resources/mine.png"));
		} catch (IOException e) {
			System.exit(-1);
		}
	}

	void paint(Graphics g, boolean showMines, boolean cheat, int x, int y, int width, int height) {
		if (isClear) {
