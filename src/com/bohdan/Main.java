...
import com.bohdan.player.Block;
import com.bohdan.player.Game;
...
public class Main {
	...
	private static final String AI_QUESTION = "User or Bot?";
	...
	public static void main(String[] args) {
		...
		switch (choice) {
			...
			default:
				do {
					width = Integer.parseInt(JOptionPane.showInputDialog("Enter field width", 9));
					height = Integer.parseInt(JOptionPane.showInputDialog("Enter field height", 9));
					mines = Integer.parseInt(JOptionPane.showInputDialog("Enter number of mines", 10));
